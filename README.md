...
Content generated by artificial intelligence, may make mistakes. [
  {"action": "move_to", "target": "WoodenDoor"},
  {"action": "open", "target": "WoodenDoor"},
  {"action": "move_to", "target": "Sword"},
  {"action": "pickup", "target": "Sword"},
  {"action": "move_to", "target": "Player"},
  {"action": "drop", "target": "Sword"}
]
```
## How it works

1. **Player chats** in Roblox's normal chat box.
